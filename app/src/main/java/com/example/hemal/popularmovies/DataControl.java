...
public class DataControl {
    ...
    private static final String TAG = DataControl.class.getSimpleName();
    ...
    public DataControl(Context mContext, MainActivityFragment object) {
    ...
    public DataControl(Context mContext) {
        this.mContext = mContext;
    }


    public DataControl(Context mContext, ReviewClass object) {
        this.mContext = mContext;
        this.mDataUpdate = object;
    }
    ...
    /**
     * Methods helps in retrieving the movies from themoviedb.org and embeds it to youtube url.
     * @param id Movie Id for which trailer links are to be retrieved.
     * @return List of urls of YoutTube videos.
     */
    ...
    /**
     * Method to retrieve author names and their reviews for particular movie.
     * @param id Movie id for which reviews are to be retrieved and parsed.
     * @return Returns list of ReviewParcelables.
     */
